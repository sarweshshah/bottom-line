        ...
        <div className="mt-2">
          {!result && !isLoading && !error && (
            <button
              ...
              disabled={isLoading}
              className="summarize-cta-button flex items-center gap-2 px-3 py-2 rounded-md text-xs font-medium bg-ai-shimmer-cta text-figma-text border border-figma-border-strong/80 overflow-hidden shadow-none hover:opacity-90 active:opacity-85 transition-opacity duration-150"
            >
